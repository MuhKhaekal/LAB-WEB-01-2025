...
@section('content')
<div class="mb-6">
    <h2 class="text-3xl font-bold text-[#EC802B]">Edit Ikan</h2>
    <p class="text-white mt-2">Update informasi ikan {{ $fish->name }}</p>
</div>
...
<div class="bg-[#66BCB4] rounded-lg shadow-md p-8">
    <form method="POST" action="{{ route('fishes.update', $fish) }}">
        ...
        <div class="mb-6">
            ...
            <select name="rarity" 
                    class="w-full px-4 py-2 border @error('rarity') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" 
                    required>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input type="number" 
                       ...
                       class="w-full px-4 py-2 border @error('base_weight_min') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" 
            ...
            <div>
                ...
                <input type="number" 
                       ...
                       class="w-full px-4 py-2 border @error('base_weight_max') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input type="number" 
                       ...
                       class="w-full px-4 py-2 border @error('sell_price_per_kg') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" 
            ...
            <div>
                ...
                <input type="number" 
                       ...
                       class="w-full px-4 py-2 border @error('catch_probability') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" 
        ...
        <div class="mb-6">
            ...
            <textarea name="description" 
                      rows="4" 
                      class="w-full px-4 py-2 border @error('description') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" 
                      placeholder="Tambahkan deskripsi tentang ikan ini...">{{ old('description', $fish->description) }}</textarea>
            @error('description')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="flex space-x-3">
            ...
            <a href="{{ route('fishes.index') }}" class="bg-red-700 hover:bg-red-500 text-white font-semibold px-6 py-3 rounded-lg shadow transition">
                Batal
            </a>
        </div>
    </form>
